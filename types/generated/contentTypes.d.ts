...
export interface ApiCarnetCarnet extends Schema.CollectionType {
  collectionName: 'carnets';
  info: {
    singularName: 'carnet';
    pluralName: 'carnets';
    displayName: 'Carnet';
...
export interface ApiDossierDossier extends Schema.CollectionType {
  ...
  attributes: {
    codeDossier: Attribute.UID;
    notes: Attribute.Relation<
      'api::dossier.dossier',
      'oneToMany',
      'api::note.note'
    >;
    anneDiag: Attribute.Date;
    insulinotherapie: Attribute.Enumeration<['Non', 'Oui']>;
    insulinotherapieDepuis: Attribute.Date;
    vaccinations: Attribute.String;
    obesite: Attribute.Enumeration<['Non', 'Oui']>;
    hypertension: Attribute.Enumeration<['Non', 'Oui']>;
    hypothyroidie: Attribute.Enumeration<['Non', 'Oui']>;
    autrePathologie: Attribute.String;
    antecedents: Attribute.Component<'dossier.antecedant'>;
    facteursRisque: Attribute.Component<'dossier.facteurs-risque'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    diabetes: Attribute.Component<'home.block-text'>;
    title: Attribute.String;
    subtitle: Attribute.String;
    description: Attribute.Text;
    cover: Attribute.Component<'home.cover'>;
...
export interface ApiHopitalHopital extends Schema.CollectionType {
  collectionName: 'hopitals';
  info: {
...
export interface ApiRvRv extends Schema.CollectionType {
  collectionName: 'rvs';
  info: {
    singularName: 'rv';
    pluralName: 'rvs';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::rv.rv', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::rv.rv', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
